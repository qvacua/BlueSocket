...
public class Socket: SocketReader, SocketWriter {
  ...
  public struct Signature: CustomStringConvertible {
    ...
    public var description: String {
      ...
      return "Signature: family: \(self.protocolFamily), type: \(self.socketType), protocol: \(self.proto), address: \(self.address as Socket.Address?), hostname: \(self.hostname as String?), port: \(self.port), path: \(String(describing: self.path)), bound: \(self.isBound), secure: \(self.isSecure)"
    }
    ...
    public init?(protocolFamily: Int32, socketType: Int32, proto: Int32, address: Address?) throws {
      ...
      guard let family = ProtocolFamily.getFamily(forValue: protocolFamily),
        ...
        throw Error(
          ...
          reason: "Bad family, type or protocol passed."
        )
      }
    ...
    public init?(socketType: SocketType, proto: SocketProtocol, path: String?) throws {
      ...
      guard lengthOfPath < MemoryLayout.size(ofValue: remoteAddr.sun_path) else {
        ...
        throw Error(
          code: Socket.SOCKET_ERR_BAD_SIGNATURE_PARAMETERS,
          reason: "Pathname supplied is too long."
        )
      }
    ...
    internal func unixAddress() throws -> (UnsafeMutablePointer<UInt8>, Int) {
      ...
      if self.path == nil {
        ...
        throw Error(
          code: Socket.SOCKET_ERR_BAD_SIGNATURE_PARAMETERS,
          reason: "Specified path contains zero (0) bytes."
        )
      }
  ...
  ///
  var readBuffer: UnsafeMutablePointer<CChar> = UnsafeMutablePointer<CChar>.allocate(
  ...
  public var isActive: Bool {
    ...
    return self.isListening || self.isConnected
  }
  ...
  public class func create(connectedUsing signature: Signature) throws -> Socket {
    ...
    let socket = try Socket(
      family: signature.protocolFamily,
      type: signature.socketType,
  ...
  public class func create(fromNativeHandle nativeHandle: Int32, address: Address?) throws -> Socket {
    ...
    guard let addr = address else {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_MISSING_CONNECTION_DATA,
        reason: "Unable to access socket connection data."
      )
    }
  ...
  ///
  public class func checkStatus(for sockets: [Socket]) throws -> (
    readables: [Socket],
    writables: [Socket]
  ) {
  ...
  ///
  public class func wait(for sockets: [Socket], timeout: UInt, waitForever: Bool = false) throws -> [
    Socket
  ]? {
    ...
    for socket in sockets {
      ...
      if socket.signature == nil {
        ...
        throw Error(
          code: Socket.SOCKET_ERR_MISSING_SIGNATURE,
          reason: "The socket is missing a signature"
        )
      }
  ...
  public func acceptClientConnection(invokeDelegate: Bool = true) throws -> Socket {
    ...
    repeat {
      do {
        guard let acceptAddress = try Address(addressProvider: { (
          addressPointer,
  ...
  public func invokeDelegateOnAccept(for newSocket: Socket) throws {
    ...
    if !newSocket.needsAcceptDelegateCall {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_INVALID_DELEGATE_CALL,
        reason: "Socket does not need a delegate accept call"
      )
    }
  ...
  public func connect(to host: String, port: Int32, timeout: UInt = 0, familyOnly: Bool = false) throws {
    ...
    if !self.isBlocking && timeout == 0 {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_PARAMETER_ERROR,
        reason: "No timeout set on call for non-blocking socket."
      )
    }
    ...
    if info!.pointee.ai_family == Int32(AF_INET6) {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_WRONG_PROTOCOL,
        reason: "Unable to determine connected socket protocol family."
      )
    }
  ...
  public func connect(to path: String) throws {
    ...
    guard let sig = self.signature, sig.protocolFamily == .unix else {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_WRONG_PROTOCOL,
        reason: "Socket has the wrong protocol, it must be UNIX socket"
      )
    }
    ...
    guard let signature = self.signature else {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_MISSING_CONNECTION_DATA,
        reason: "Unable to access connection data."
      )
    }
  ...
  ///
  public func listen(
    forMessage buffer: UnsafeMutablePointer<CChar>,
    bufSize: Int,
    on port: Int,
    maxBacklogSize: Int = Socket.SOCKET_DEFAULT_MAX_BACKLOG
    ...
    if bufSize == 0 {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_INVALID_BUFFER,
        reason: "Socket has an invalid buffer, the size is zero"
      )
    }
    ...
    if self.readStorage.count > 0 {
      ...
      if bufSize < self.readStorage.count {
        ...
        if truncate {
          ...
          _ = self.readStorage.copyBytes(
            to: UnsafeMutableBufferPointer(
              start: UnsafeMutableRawPointer(buffer).assumingMemoryBound(to: UInt8.self),
              count: bufSize
            )
          )
  ...
  public func readDatagram(into buffer: UnsafeMutablePointer<CChar>, bufSize: Int) throws -> (
    ...
    if bufSize == 0 {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_INVALID_BUFFER,
        reason: "Socket has an invalid buffer, size is zero"
      )
    }
  ...
  @discardableResult public func write(from buffer: UnsafeRawPointer, bufSize: Int) throws -> Int {
    ...
    if bufSize == 0 {
      ...
      throw Error(
        code: Socket.SOCKET_ERR_INVALID_BUFFER,
        reason: "The buffer is not valid, its size is zero"
      )
    }
      ...
      if self.delegate != nil {
        ...
        repeat {
          ...
          do {
            ...
            s = try self.delegate!.send(
              buffer: buffer.advanced(by: sent),
              bufSize: Int(bufSize - sent)
            )
